...
class UserController extends AbstractController
{
    ...
    public function nickEdit(Request $request, User $user): Response
    {
    ...
    public function passEdit(Request $request, User $user): Response
    {
        if (!$this->isGranted('EDIT', $user)) {
            return $this->redirectToRoute('index');
        }
    ...
    public function userToggleBlock(Request $request, User $user): Response
    {
